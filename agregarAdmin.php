...
////obtener los valores de las variables del formulario
    ...
    if(!isEmail($email)){
        $errors[] = "Dirección de correo no válida";
    }
    ...
    if(count($errors) == 0){
        ///Registrar nuevo Admente y usuario
        $sql = "INSERT INTO admin (Codigo_Adm, Cedula_Adm, Nombre_Adm, Apellidos_Adm,  Correo_Adm, Cel_Adm) VALUES ('$codigo','$cedula','$nombre','$apellidos', '$email',   '$celular')";
        $resultado=$mysqli->query($sql);
        //echo $resultado;

        $pass= sha1 ($cedula);
        $sql2 = "INSERT INTO usuarios (Id_Usuario, Usuario, Password, Nombre_Usuario, Tipo_Usuario) VALUES ('$codigo','$codigo', '$pass', 'ADMINISTRADOR', '1')";
        $resultado2=$mysqli->query($sql2);

        if($resultado){
            $mensaje[] ="El Admin $nombre $apellidos ha sido registrado exitosamente";
            ////////enviar un correo//////////////////////////////////////
            ...
            $errors[] = "Falló registrar el Admin. ";
        }
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Registrar Nuevo Administrador</h1>
                            </div>
