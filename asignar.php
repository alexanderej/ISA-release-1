<?php
   ...
   if (!isset($_SESSION['Id_Usuario'])) {
    ...
    $nombre="";
    $id_Estudiante = $_GET['id_E'];
    $id_Docente = $_GET['id_D'];
    $id_Proyecto = $_GET['id_P'];
    ...
    $sql = "UPDATE estudiantes SET Codigo_Doc='$id_Docente' WHERE Codigo_Est = '$id_Estudiante'";
    $resultado=$mysqli->query($sql);
    $sql2 = "UPDATE docentes SET Codigo_Est='$id_Estudiante', Cod_proyecto='$id_Proyecto' WHERE Codigo_Doc = '$id_Docente'";
    $resultado2=$mysqli->query($sql2);
    $sql3 = "UPDATE proyecto SET Codigo_Doc='$id_Docente' WHERE Cod_proyecto = '$id_Proyecto'";
