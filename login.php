                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-none d-lg-block ">
                                <br>
                                <img align="right" src="img/acreditacion.png" width="400 px", height="400 px">
                                <br>
                                <br>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Universidad De Nariño <br> Inscripcion Proyecto De Grado</h1>
                                    </div>
