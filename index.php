        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span>Inscripcion Trabajo De grado</span>
                </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Importante</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Tener aprobado el 75% de la totalidad de los creditos de su plan de estudio, incluidos los de formacion humanistica y competencias basicas </div>
                                        </div>
                                        <div class="col-auto">
